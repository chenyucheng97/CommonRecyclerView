package com.example.unicorn.commonrecyclerview_library.adapter;
...
import com.example.unicorn.commonrecyclerview_library.base.ItemViewDelegateManager;
...
public class MultiItemTypeAdapter<T> extends RecyclerView.Adapter<ViewHolder>
{
    ...
    public int getItemViewType(int position)
    {
        ...
        return mItemViewDelegateManager.getItemViewType(mDatas.get(position), position-1);
    }
